...
resource "local_file" "literature" {
    ...
    content = <<-EOT
      Sun Tzu said: The art of war is of vital iportance to the State.

      It is a matter of life and death, a road either to safety or to
      ruin. Hence it is a subject of inquiry which can no account be neglected.
      ...
      determine the conditions obtaining the field.
